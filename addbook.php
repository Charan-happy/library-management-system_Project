...
Adduser($book_name,$author,$cost,$company);

function Adduser($book_name,$author,$cost,$company)
{?>
<html>
<head>
<style>
...
<?php
  ...
  { 
    ...
    require_once 'db_connect.php';
    $sql = mysqli_query($conn,"INSERT into books(Author,Book,Cost,Company) VALUES ('".$author."','".$book_name."','".$cost."','".$company."')");
    if($sql)
    {
