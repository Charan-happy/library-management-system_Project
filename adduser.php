<?php
$user_name = $dob = $email = $address = $pwd = $mobile = $access = "";
...
function Adduser($user_name,$dob,$email,$address,$pwd,$mobile,$access)
{?>
<html>
<head>
<style>
...
<div class="row">
  ...
  { 
    ...
    else
    {
      ...
      $sql = mysqli_query($conn,"INSERT into users(Name, Dob, Mobile, Email, Access_type, Address, Password) VALUES ('".$user_name."','".$dob."','".$mobile."','".$email."','".$access."','".$address."','".$pwd."')");
      if($sql)
      {
